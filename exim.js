...
},{"./Actions":3,"./DOMHelpers":4,"./Getter":6,"./GlobalStore":7,"./Store":8,"./helpers":10}],2:[function(require,module,exports){
/**
...
var GlobalStore = (function () {
  ...
  _createClass(GlobalStore, null, {
    ...
    setSubstore: {
      value: function setSubstore(path, newValues) {
        var store = this.getStore();
        var pathBits = path.split("/");
    ...
    get: {
      value: function get(substore, name) {
        ...
        if (!name) {
          return values.toJS();
        }var value = values ? values.get(name) : {};
...
},{"./utils":12,"immutable":2}],8:[function(require,module,exports){
"use strict";
...
},{"./Actions":3,"./Getter":6,"./GlobalStore":7,"./mixins/connect":11,"./utils":12}],9:[function(require,module,exports){
"use strict";
